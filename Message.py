...
class Message:
    ...
    # id (int): message ID
    # patient_name (string): name of the patient who sent the message
    # severity (int): how serious is the message
    # location (string): where is the message sent from
    # message (string): actual message
    def __init__(self, id: int, patient_name: str, severity: int, location: str, message: str):
        strings_concatenated = patient_name + location + message
    ...
    #
    #                   format:
    #                       [id];[patient_name];[severity];[location];[message]
    ...
    def from_string(self, message: str) -> "Message":
        ...
        try:
            ...
            return Message(id, patient_name, severity, location, msg)
